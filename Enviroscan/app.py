...
co = st.sidebar.number_input("CO AQI Value", 0.0, 500.0, 150.0)
no2 = st.sidebar.number_input("NO₂ AQI Value", 0.0, 500.0, 140.0)
ozone = st.sidebar.number_input("Ozone AQI Value", 0.0, 500.0, 130.0)
pm25 = st.sidebar.number_input("PM2.5 AQI Value", 0.0, 500.0, 160.0)
aqi = st.sidebar.number_input("Overall AQI", 0.0, 500.0, 240.0)
